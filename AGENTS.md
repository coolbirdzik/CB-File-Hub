...
- **Video:** shared media_kit backend (`lib/services/media/media_kit_playback.dart`), using `media_kit` 1.2.6, `media_kit_video` 2.0.1 and `media_kit_libs_video` 1.0.7. See `docs/technical/07-media-kit-playback.md`.
