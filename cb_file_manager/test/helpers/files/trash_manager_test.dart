...
void main() {
  group('TrashManager permanent deletion', () {
    ...
    test(
      'deletes files and directories with bounded concurrent workers',
      () async {
        final paths = <String>[];
        ...
        await File(
          '${nestedDirectory.path}${Platform.pathSeparator}nested.log',
        ...
        expect(
          progress,
          List<int>.generate(paths.length, (index) => index + 1),
        );
